...
const PlantCareBasics = () => {
  ...
  return (
    <div className="px-4 py-16 mx-auto container md:px-8">
      <div className="max-w-2xl mx-auto mb-10 text-center">
        ...
        <h2 className="text-3xl font-extrabold text-green-700 flex items-center justify-center gap-3 mb-4">
          <FaLeaf className="text-green-500 text-2xl" /> Plant Care Basics
        </h2>
        <p className="text-base text-gray-700 md:text-lg">A collection of simple, effective tips to help your plants thrive all year long.</p>
      </div>

      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
        {tips.map((tip, index) => (
          <div key={index} className="p-6 bg-white border border-green-200 rounded-2xl shadow-md transition duration-300 hover:shadow-xl">
            ...
            <h6 className="mb-2 text-xl font-bold text-green-800">{tip.title}</h6>
